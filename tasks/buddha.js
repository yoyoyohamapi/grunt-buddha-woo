...
module.exports = function (grunt) {
  ...
  grunt.registerMultiTask('buddha', 'Grunt 插件编写测试', function () {
      ...
      file.src.filter(function (filepath) {
        ...
        var originalFileContent = grunt.file.read(filepath),
            newFileContent = commentContent + 
                             ...
                             originalFileContent;
            if(textExistsRegexMap[who].test(originalFileContent)) {
              return;
            }
        // Read file source.
